...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		newslettermodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	NewsletterKeeper newslettermodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		newslettermoduletypes.StoreKey,
	...
	*/
	...
	app.NewsletterKeeper = *newslettermodulekeeper.NewKeeper(
		...
		app.GetSubspace(newslettermoduletypes.ModuleName),
	)
	newsletterModule := newslettermodule.NewAppModule(appCodec, app.NewsletterKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		newslettermoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(newslettermoduletypes.ModuleName)
